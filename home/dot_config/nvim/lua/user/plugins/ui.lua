  ...
  "sindrets/winshift.nvim",
  {
    ...
    config = function()
      ...
      function _G.set_terminal_keymaps()
        vim.api.nvim_buf_set_keymap(0, "t", [[<C-\>]], "<CMD>FloatermToggle<CR>", { noremap = true, silent = true })
        vim.api.nvim_buf_set_keymap(0, "t", [[<C-k>]], "<CMD>FloatermKill<CR>", { noremap = true, silent = true })
