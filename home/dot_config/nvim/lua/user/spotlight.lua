...
local space = function(keys, desc)
    vim.keymap.set("n", "<Space>" .. keys,
                   function() km.open_window("<Space>" .. keys) end,
                   {desc = desc})
end
...
vim.keymap.set("n", "<Space>ad", require("neogen").generate,
...
vim.keymap.set("n", "<Space>ala", vim.lsp.buf.code_action,
               {desc = "Code actions"})
vim.keymap.set("n", "<Space>ald", vim.lsp.codelens.run,
               {desc = "Code lens / Run"})

-- Minor mode: Goto
space("g", "Goto")

vim.keymap.set("n", "<Space>ga", require("hop").hint_words,
               {desc = "Hop / Words"})

-- -- LSP
space("gl", "LSP")
vim.keymap.set("n", "<Space>gls", "<CMD>Telescope lsp_document_symbols<CR>",
               {desc = "Symbols / Document"})
vim.keymap.set("n", "<Space>glS", "<CMD>Telescope lsp_workspace_symbols<CR>",
               {desc = "Symbols / Workspace"})
vim.keymap.set("n", "<Space>glh", "<CMD>Telescope diagnostics bufnr=0<CR>",
               {desc = "Diagnostics / Document"})
vim.keymap.set("n", "<Space>glH", "<CMD>Telescope diagnostics<CR>",
               {desc = "Diagnostics / Workspace"})
vim.keymap.set("n", "<Space>gld", vim.lsp.buf.definition, {desc = "Definition"})
vim.keymap.set("n", "<Space>glD", vim.lsp.buf.declaration,
               {desc = "Declaration"})
vim.keymap.set("n", "<Space>gli", vim.lsp.buf.implementation,
               {desc = "Implementation"})
vim.keymap.set("n", "<Space>glt", vim.lsp.buf.type_definition,
...
vim.keymap.set("n", "<Space>htv", "<CMD>NvimTreeFindFile<CR>",
               {desc = "Find file"})

-- -- LSP
space("hl", "LSP")
vim.keymap.set("n", "<Space>hlk", vim.lsp.buf.hover, {desc = "Hover"})
vim.keymap.set("n", "<Space>hls", vim.lsp.buf.signature_help,
               {desc = "Signature help"})
...
vim.keymap.set("n", "<Space>of", "<CMD>Telescope file_browser<CR>",
               {desc = "File browser"})
...
vim.keymap.set("n", "<Space>ff", "<CMD>Telescope find_files<CR>",
               {desc = "Files"})
vim.keymap
    .set("n", "<Space>fg", "<CMD>Telescope live_grep<CR>", {desc = "Grep"})
...
vim.keymap.set("n", "<Space>pe", vim.diagnostic.goto_prev,
               {desc = "Error", silent = true})
vim.keymap.set("n", "<Space>pq", "<CMD>cprevious<cr><cr>",
               {desc = "quickfix item"})
vim.keymap.set("n", "<Space>pc", require("gitsigns.actions").prev_hunk,
               {desc = "Change"})
...
vim.keymap.set("n", "<Space>nc", require("gitsigns.actions").next_hunk,
               {desc = "Change"})
...
vim.keymap.set("n", "<Space>rtj", "<CMD>UltestStopNearest<CR>",
               {desc = "Nearest (Stop)"})
...
vim.keymap.set("n", "<Space>sfs", '<CMD>:let @*=expand("%")<CR>',
               {desc = "Name"})
vim.keymap.set("n", "<Space>sfl", '<CMD>:let @*=expand("%:p")<CR>',
               {desc = "Path"})
