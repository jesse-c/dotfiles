((ace-window :source "elpaca-menu-lock-file" :recipe
  ...
  (agent-shell-ediff :source "elpaca-menu-lock-file" :recipe
    (:source "elpaca-menu-lock-file" :package "agent-shell-ediff" :id
      agent-shell-ediff :host github :repo
      "cassandracomar/agent-shell-ediff" :type git :protocol https
  ...
  (csv-mode :source "elpaca-menu-lock-file" :recipe
    (:package "csv-mode" :repo
      ...
      :ref "3a441a41a3b1d61c2a9c9f5f091cb38ba6b45d47"))
